...
sel.VX<-round(seq(1, nLVars, 4))
sel.VdX<-round(seq(2, nLVars, 4))
sel.Vd2X<-round(seq(3, nLVars, 4))
sel.Node<-round(seq(4, nLVars, 4))
...
AA.v<-rbind(matrix(0,nLVars, nTot) , cbind(LMatrix, matrix(0,nLVars,nLVars)))
